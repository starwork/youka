<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\myphp_www\PHPTutorial\WWW\mall\web/../source/application/store\view\store\rule\edit.php";i:1557384200;s:82:"D:\myphp_www\PHPTutorial\WWW\mall\source\application\store\view\layouts\layout.php";i:1557881619;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="rule[is_menu]" value="0" data-am-ucheck=""  <?= $model['is_menu'] == 0 ? 'checked' : '' ?> class="am-ucheck-radio am-field-valid"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
                                        不显示
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="rule[is_menu]" value="1" data-am-ucheck=" " <?= $model['is_menu'] == 1 ? 'checked' : '' ?> class="am-ucheck-radio am-field-valid"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
                                        显示
                                    </label>
                                </div>
                            </div>
