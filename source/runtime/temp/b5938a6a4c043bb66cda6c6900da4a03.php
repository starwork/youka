<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"D:\myphp_www\PHPTutorial\WWW\mall\web/../source/application/store\view\store\group\index.php";i:1558076537;s:82:"D:\myphp_www\PHPTutorial\WWW\mall\source\application\store\view\layouts\layout.php";i:1557993091;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="row">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <?php if (check_auth('store.group/delete',$store['user']['store_user_id'])):  ?>
                <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                    <div class="am-form-group">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a class="am-btn am-btn-default am-btn-success am-radius"
                                   href="<?= check_url('store.group/add',$uid) ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= check_url('store.group/edit',$uid,
                                                ['id' => $item['id']]) ?>">
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('store.group/delete') ?>";
