<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\myphp_www\PHPTutorial\WWW\mall\web/../source/application/store\view\store\user\edit.php";i:1557383925;s:82:"D:\myphp_www\PHPTutorial\WWW\mall\source\application\store\view\layouts\layout.php";i:1557993091;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <select name="user[group_ids][]"
                                        ...
                                        <?php if (isset($list)): foreach ($list as $first): ?>
                                            <option value="<?= $first['id'] ?>"
                                                <?= in_array($first['id'],$group_ids) ? 'selected' : '' ?>>
                                                <?= $first['title'] ?></option>
