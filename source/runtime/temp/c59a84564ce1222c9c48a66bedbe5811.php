<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\myphp_www\PHPTutorial\WWW\mall\web/../source/application/store\view\setting\privacy.php";i:1559203862;s:82:"D:\myphp_www\PHPTutorial\WWW\mall\source\application\store\view\layouts\layout.php";i:1560391351;s:98:"D:\myphp_www\PHPTutorial\WWW\mall\source\application\store\view\layouts\_template\file_library.php";i:1557023558;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="container" name="privacy[content]" type="text/plain"><?= $values['content'] ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
