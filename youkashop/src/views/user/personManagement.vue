...
<template>
    ...
    <div class="vol-data">
      <div class="charts" style="width:'100%',height:'6.54rem'">
        ...
        <div id="myChart" ref="charts" :style="style">
        </div>
      </div>
    </div>
    <div class="wealthLink" ref="footer">
        <div @click="goToPage('/user/teamManagement')" class="w-banner1">
              <img class="team-manage" src="../../assets/team/footer1.png" alt="">
              <p>团队管理</p>
          </div>
          <div @click="goToPage('/user/teamAchieve')" class="w-banner1">
              <img class="team-yeji" src="../../assets/team/footer2.png" alt="">
              <p>团队业绩</p>
          </div>
          <div class="w-banner1" @click="goToPage('/user/userQR')">
              <img class="yaoqing" src="../../assets/team/footer3.png" alt="">
              <p>邀请代理</p>
          </div>
          <div @click="goToPage('/user/myInvitation')" class="w-banner1">
              <img class="my-yaoqing" src="../../assets/team/footer4.png" alt="">
              <p>我的邀请</p>
          </div>
    </div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      week30:['04.01', '04.05', '04.10', '04.15', '04.20', '04.25', '04.30'],
      datainit:[11, 11, 15, 13, 12, 13, 10],
      datainit7:[11, 78, 15, 36, 12, 13, 45],
      datainit15:[11, 30, 15, 20, 12, 52, 10,30],
      datainit30:[11, 84, 15, 13, 64, 13, 23]
    }
  },
  updated() {
	// const self = this;
	// var top = self.$refs.charts.offsetTop;
	// var footer_height = self.$refs.footer.offsetHeight;
	// console.log('top'+top)
	// console.log('footer_height'+footer_height)
	// this.style.height = window.innerHeight-top-footer_height+;
	// self.changeCharts();
	// setTimeout(function(){
	// 	self.myChart.resize();
	// },200)
  ...
  mounted () {
   ...
   console.log('top'+top)
   console.log('footer_height'+footer_height)
   this.style.height = window.innerHeight-20-top-footer_height+'px';
   self.changeCharts();
   setTimeout(function(){
   	self.myChart.resize();
   },200)
...
<style lang="less">
  ...
  .charts{
    background: linear-gradient(to right,#FE945A,#F6603B);
    .charts-title{
